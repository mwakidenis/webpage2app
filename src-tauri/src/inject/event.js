...
// Watermark injection - permanent, subtle, difficult to remove
function injectWatermark() {
  // Prevent duplicate insertion
  if (document.getElementById("wm-webpg2app")) return;

  const text = "mwakidenis";
  const colors = ["black", "red"]; // Alternating black/red
  ...
  // Create each letter with alternating colors

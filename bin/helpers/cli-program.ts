...
import {
  DEFAULT_WEBPG2APP_OPTIONS as DEFAULT,
  DEFAULT_WEBPG2APP_OPTIONS,
} from '../defaults';
  ...
  return program
    ...
    .addOption(
      new Option(
        ...
        .default(DEFAULT_WEBPG2APP_OPTIONS.proxyUrl)
        .hideHelp(),
    )
    .addOption(
    ...
    .addOption(
      new Option('--activation-shortcut <string>', 'Shortcut key to active App')
        .default(DEFAULT_WEBPG2APP_OPTIONS.activationShortcut)
        .hideHelp(),
    )
    .addOption(
    ...
    .addOption(
      new Option('--hide-on-close [boolean]', 'Hide window on close')
    ...
    .addOption(
      new Option('--multi-window', 'Allow multiple windows')
    ...
    .addOption(
      new Option(
        ...
        'Keep every link inside the webpg2app window',
      )
    ...
    .addOption(
      new Option('--ignore-certificate-errors', 'Ignore certificate errors')
        .default(DEFAULT.ignoreCertificateErrors)
        .hideHelp(),
    )
    .addOption(
      new Option('--iterative-build', 'Rapid build mode')
